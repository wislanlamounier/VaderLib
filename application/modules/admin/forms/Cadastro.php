<?php
class Admin_Form_Cadastro extends Zend_Validate
{
///==============================================================================================================
//Validadores
//==============================================================================================================
  ...
  public function ValidaEmailParaCadastro($email)
  {
    ...
    else
    {
      try 
      {
        $obj = new Application_Model_DbTable_Usuarios();
    ...
    try
      {
        ...
        if(empty($Crop))
        {
          $imagizer->fitSize(350);
          $imagizer->byHeight(350);
          $imagizer->byWidth(350);
        }
